...
def main_entry(input):
    ...
    if addr_p2wpkh:
        if public_key_hash160 == 'bc1qzgujzqeg4sht0dme6za87usp6pn2e5exhemenp':
        ...
        elif addr_p2wpkh == 'bc1qzgujzqeg4sht0dme6za87usp6pn2e5exhemenp':
    ...
    if addr_p2tr == 'bc1qzgujzqeg4sht0dme6za87usp6pn2e5exhemenp':
        if addr_p2tr:
            print("bech32m address (p2tr) = {}".format(addr_p2tr))
        if mnemonic:
            print("mnemonic = {}".format(mnemonic))
...
if __name__ == '__main__':
    ...
    words = ["law", "hundred", "found", "transfer", "life", "blouse", "wine", "sting", "test", "test", "test", "test"]
